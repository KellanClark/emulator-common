#ifndef ARM946E_DISASM_HPP
#define ARM946E_DISASM_HPP

#include "types.hpp"

class ARM946EDisassembler {
public:
	struct {
    ...
    std::string disassemble(u32 address, u32 opcode, bool thumb) {
		...
		case 0xE:
		case 0xF: conditionCode = options.showALCondition ? "AL" : ""; break;
		}
		...
		if (thumb) {
			...
			if ((lutIndex & thumbAddSubtractMask) == thumbAddSubtractBits) {
				...
				case 3: disassembledOpcode << (opFlag1 ? "BLX " : "BX "); break;
				}
